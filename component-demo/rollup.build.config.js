...
export default {
  input: 'src/components/ComponentDemo.vue', // 输入文件
  // 输出，告诉rollup一些重要的信息
  output: {
    globals: {
    ...
    // assetDir: './assets',
    name: 'ComponentDemo', // 仓库或组件的名字，如果使用<script>引入方式则为暴露在window对象下的全局的变量名称
    file: `npm/lib/component-demo.${argv.format}.min.js`, // 我们要生成的文件目录（css是自动创建）
  ...
  plugins: [
    ...
    styles({
      ...
      mode: ["extract", "component-demo.css"],
